...
inherit eutils multilib distutils-r1 systemd user
...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="docs jemalloc +precompiled-web python tcmalloc"
...
src_install() {
	...
	use docs && install_opts+=(install-docs)
	emake STRIP_ON_INSTALL=0 VERBOSE=0 DESTDIR="${D}" "${install_opts[@]}"
